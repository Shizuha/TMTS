		...
		<div class="container-fluid">
			...
			<button id ="usernewpwd">비밀번호초기화</button></div><br>
				...
				<div id="pagebox" align="right" style="margin-right: 30px;">
					...
					%>
					<a href="/NHMP/list?page=<%=maxPage%>"><i class="fas fa-angle-double-right"></i></a>
					<%
						} else {
					%>
					<a href="/NHMP/list?page=<%=endPage + 10%>"><i class="fas fa-angle-double-right"></i></a>
					<%
						}
					%>
					&nbsp; <a href="/NHMP/list?page=<%=maxPage%>"><i class="fas fa-angle-right">끝 페이지로</i></a>
				</div>
			</div>
        </div>
