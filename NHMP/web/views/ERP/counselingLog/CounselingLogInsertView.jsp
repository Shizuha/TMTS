				...
				<form action="/NHMP/counselinsert" method="post"
					...
					<table align="center" width="800" border="3" cellspacing="0"
						...
						<tr>
							...
							<td><input type="number" name="cl_no" id="cl_no" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">제목</th>
							<td><input type="text" name="cl_title" id="cl_title" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">날짜</th>
							<td><input type="date" name="cl_date" id="cl_date" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">내용</th>
							<td><input type="text" name="cl_contents" id="cl_contents" style="font-size : 16px; width : 500px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">연락처</th>
							<td><input type="tel" name="cl_phone" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">비고</th>
							<td><input type="text" name="cl_comment" id="cl_comment" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">환자명</th>
							<td><input type="text" name="cl_pat_name" id="cl_pat_name" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">상담자</th>
							<td><input type="text" name="cl_emp_name" id="cl_emp_name" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th style="font-size : 16px;">첨부파일</th>
							<td><input type="file" name="cl_original_filename"
								id="cl_original_filename" style="font-size : 16px;"></td>
						</tr>
						<tr>
							<th colspan="2" align="center"><input type="submit"
								...
								<input type="button" value="목록" onclick="return clList();" style="font-size : 16px;">
