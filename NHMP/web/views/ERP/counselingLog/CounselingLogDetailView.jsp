			...
			<form action="/NHMP/counseldetail" method="post"
				...
				<table align="center" width="600" cellspacing="0" cellpadding="5"
					...
					<tr>
						<th>상담일지번호</th>
						<td><input
								type="number" name="cl_no" id="cl_no"
								value="<%=counselingLog.getClNo()%>"></td>
					</tr>
					<tr>
						<th>제목</th>
						<td><input type="text" name="cl_title" id="cl_title"
							value="<%=counselingLog.getClTitle()%>"></td>
					</tr>
					<tr>
						<th>날짜</th>
						<td><input type="date" name="cl_date" id="cl_date"
							value="<%=counselingLog.getClDate()%>"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><input type="text" name="cl_name" id="cl_name"
							value="<%=counselingLog.getClContents()%>"></td>
					</tr>
					<tr>
						<th>연락처</th>
						<td><input type="tel" name="cl_phone" id="cl_phone"
							value="<%=counselingLog.getClPhone()%>"></td>
					</tr>
					<tr>
						<th>비고</th>
						<td><input type="text" name="cl_comment" id="cl_comment"
							value="<%=counselingLog.getClComment()%>"></td>
					</tr>
					<tr>
						<th>환자명</th>
						<td><input type="text" name="cl_pat_name" id="cl_pat_name"
							value="<%=counselingLog.getClPatName()%>"></td>
					</tr>
					<tr>
						<th>상담자</th>
						<td><input type="text" name="cl_emp_name" id="cl_emp_name"
							value="<%=counselingLog.getClEmpName()%>"></td>
					</tr>
					<tr>
						<th>첨부파일</th>
						<td>
					...
					<tr>
						<th colspan="2" align="center"><input type="button" value="수정하기"
							onclick="return moveupdate();"> &nbsp; &nbsp; &nbsp; <input type="submit"
							value="삭제" onclick="return movedelete();"> &nbsp; &nbsp; &nbsp; <input
							type="button" value="목록" onclick="return movemain();"> &nbsp; &nbsp; &nbsp; <a
