					...
					<table align="center" width="800" cellspacing="0" cellpadding="5"
						...
						<tr>
							<th colspan="2"><input type="button" value="수정하기"
								onclick="return moveupdate();" style="font-size : 16px;"> <input type="submit"
								value="삭제" onclick="return movedelete();" style="font-size : 16px;"> <input
								type="button" value="목록" onclick="return movemain();" style="font-size : 16px;"> <a
