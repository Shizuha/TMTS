	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		...
		<center>
			<div class="searchbox">
				<div>
					...
					제목 &nbsp; &nbsp; &nbsp; <input type="radio" name="click"
						value="cl_emp_name"> 상담자 &nbsp; &nbsp; &nbsp;
				</div>
				<div id="cl_title_div">
					<form action="/NHMP/counselsearch" method="post">
						<input type="hidden" name="search" value="cl_title"> <label>검색할
				...
				<div id="cl_emp_name_div">
					<form action="/NHMP/counselsearch" method="post">
						<input type="hidden" name="search" value="cl_emp_name"> <label>검색할
		...
		<div class="content-body">
			<table align="center" width="1400" border="3" cellspacing="1" cellpadding="5">
				<tr>
					<th>상담일지번호</th>
					<th>제목</th>
					<th>날짜</th>
				...
				%>
				<tr>
					<th colspan="30" align="center"><input type="button" value="등록하기"
						onclick="return moveinsert();"> &nbsp; &nbsp; <input
						type="reset" value="취소"> &nbsp; &nbsp; <input
						type="button" value="목록" onclick="return movemain();">
