		...
		<div class="content-body">
			<form action="/NHMP/counselupdate" method="post"
				...
				<table align="center" width="1000" border="3" cellspacing="0"
					...
					<tr>
						<th>상담일지번호</th>
						<td><input type="number" name="cl_no"></td>
					</tr>
					<tr>
						<th>제목</th>
						<td><input type="text" name="cl_title"></td>
					</tr>
					<tr>
						<th>날짜</th>
					...
					<tr>
						<th>내용</th>
						<td><input type="text" name="cl_contents"></td>
					</tr>
					<tr>
						<th>연락처</th>
					...
					<tr>
						<th>환자명</th>
						<td><input type="text" name="cl_pat_name"></td>
					</tr>
					<tr>
						<th>상담자</th>
						<td><input type="text" name="cl_emp_name"></td>
					</tr>
					<tr>
						<th>첨부파일</th>
						<td><input type="file" name="cl_original_filename"></td>
					</tr>
					<tr>
