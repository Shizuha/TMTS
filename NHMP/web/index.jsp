...
<head>
    ...
    <title>NHMP</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="resources/images/ERP/assets/favicon.png">
    <!-- <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous"> -->
    <link href="resources/css/ERP/style.css" rel="stylesheet">
...
<body class="h-100">
    ...
    ***********************************-->
    ...
    <script src="resources/js/ERP/styleSwitcher.js"></script>
</body>
</html>