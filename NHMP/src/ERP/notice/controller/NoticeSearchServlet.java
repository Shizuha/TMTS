...
public class NoticeSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "title":	String noticeTitle = request.getParameter("keyword");
						list = nservice.selectTitleSearch(noticeTitle);
						break;
		case "writer":	String noticeWriter = request.getParameter("keyword");
						list = nservice.selectWriterSearch(noticeWriter);
						break;
		case "date": String beginDate = request.getParameter("from");
					 String toDate = request.getParameter("to");
					 list = nservice.selectDateSearch(Date.valueOf(beginDate),Date.valueOf(toDate));	
					 	break;
		}
